...
export default function Datepicker({
  ...
  if (value) {
    if (value instanceof moment) initialValue = value;
    else if (isISODate(value)) initialValue = moment(value);
  }
  const [privateValue, setPrivateValue] = useState(initialValue);

  const blurHandler = () => onBlur(privateValue);
